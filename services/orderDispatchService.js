      ...
      if (products && products.length > 0) {
        for (let i = 0; i < products.length; i++) {
          ...
          const orderRow = new OrderDispatch({
            ...
            planned_1: orderData.order_type?.toLowerCase() === 'pre approval' ? new Date().toISOString() : null,
            planned_2: orderData.order_type?.toLowerCase() === 'regular' ? new Date().toISOString() : null,
            // For regular orders, set remaining_dispatch_qty to order_quantity immediately
            remaining_dispatch_qty: orderData.order_type?.toLowerCase() === 'regular' ? product.order_quantity : null,
        ...
        const orderRow = new OrderDispatch({
          ...
          planned_2: orderData.order_type?.toLowerCase() === 'regular' ? new Date().toISOString() : null,
          // For regular orders, set remaining_dispatch_qty to order_quantity immediately
          remaining_dispatch_qty: orderData.order_type?.toLowerCase() === 'regular' ? orderData.order_quantity : null,
          // order_no will be auto-generated by database trigger
        });
